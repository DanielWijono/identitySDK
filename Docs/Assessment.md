...
4. M4 adapter, in-process demo service, independent HTTP server and live lost-response tests are implemented. The remaining M4 item is the foreground/background reconciliation adapter.
