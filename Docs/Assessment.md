...
- Session lifetime is capped at 15 minutes using monotonic task sleep. Wall-clock expiry is also checked at operation boundaries. Clock injection and suspension/foreground tests remain necessary.
...
1. Complete M0/M1 with UIKit and SwiftUI consumers, explicit review/recovery transition tests, injectable time, and cancellation tests at every async boundary.
...
The original plan is retained unchanged as the proposed release specification. No deployment, public release, or Git history was created.
