...
M0/M1 foundations and most of the M2 secure-evidence lifecycle are implemented; M3 camera capture is code-complete and its remaining gates are physical. This is not a v0.1 release. UIKit and SwiftUI simulation hosts are available. Image normalization and encrypted storage are integrated into the iOS sample hosts; see [normalization](Docs/Image-Normalization.md) and [vault contract and remaining gates](Docs/Evidence-Vault.md).
